...
public class TestSorting {
	...
	static void testInsertionSort(int[] array, boolean ordered) {
		...
		output("Insertion sort " + "runtime on " + (ordered ? "ordered" : "random") + " array of length " + array.length
	...
	static void testInPlaceHeapSort(int[] array, boolean ordered) {
		...
		long endTime = System.currentTimeMillis();
		long timeToSolve = endTime - startTime; // Time in milliseconds
		output("In place heap sort " + "runtime on " + (ordered ? "ordered" : "random") + " array of length "
	...
	static void testObjectBasedHeapSort(int[] array, boolean ordered) {
		...
		long endTime = System.currentTimeMillis();
		long timeToSolve = endTime - startTime; // Time in milliseconds
		output("Object-based heap sort " + "runtime on " + (ordered ? "ordered" : "random") + " array of length "
				+ array.length + ":  " + timeToSolve + " milliseconds");
